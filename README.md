...
![Preview Image](https://github.com/shamelsk/wanderlust/assets/116620586/17ba9da6-225f-481d-87c0-5d5a010a9538)
#
...
<img src="https://github.com/shamelsk/Wanderlust-Mega-Project/blob/main/Assets/DevSecOps%2BGitOps.gif" />
...
- <b id="EKS">Create EKS Cluster on AWS (Master machine)</b>
  ...
  - AWSCLI should be configured (<a href="https://github.com/shamelsk/DevOps-Tools-Installations/blob/main/AWSCLI/AWSCLI.sh">Setup AWSCLI</a>)
  ```bash
  ...
  - Install **kubectl** (Master machine)(<a href="https://github.com/shamelsk/DevOps-Tools-Installations/blob/main/Kubectl/Kubectl.sh">Setup kubectl </a>)
  ```bash
  ...
  - Install **eksctl** (Master machine) (<a href="https://github.com/shamelsk/DevOps-Tools-Installations/blob/main/eksctl%20/eksctl.sh">Setup eksctl</a>)
  ```bash
...
- <b id="Jenkins-worker">Setting up jenkins worker node</b>
  ...
  - Configure AWSCLI (<a href="https://github.com/shamelsk/DevOps-Tools-Installations/blob/main/AWSCLI/AWSCLI.sh">Setup AWSCLI</a>)
  ```bash
  sudo su
  ```
  ```bash
