...
-  Setup <a href="https://github.com/shamelsk/Wanderlust/blob/devops/kubernetes/kubeadm.md"><u> Kubeadm </a></u>
...
```bash
git clone -b devops https://github.com/shamelsk/Wanderlust.git
```
...
docker push shamelsk/backend-Wanderlust:v2.1.8
```
...
```
![App](https://github.com/shamelsk/Wanderlust/blob/devops/kubernetes/assets/app.png)
